...
button{
  border-radius:40px;
    ...
    <body style="background-image: url(Bg.jpg);background-attachment: fixed;background-size: cover;">
        ...
        <ul>
            <li><a href="http://localhost/Surya/AdminHome.php">Home</a></li>
            <li><a href="http://localhost/Surya/AllAdminServices.php">Services</a></li>
            <li><a href="http://localhost/Surya/AdminFacilities.php">Facilities</a></li>
            <li><a href="http://localhost/Surya/AdminComplaints.php">Complaints</a></li>
            <li><a href="http://localhost/Surya/AdminInfo.html">Info</a></li>
            <li style="float:right"><a class="active" href="http://localhost/Surya/LogOut.php">LogOut</a></li>
            
          </ul>
          <br>
          <h3 style="color:red;text-align:center;"><---This redirects to user pages---></h3>
          <br>
