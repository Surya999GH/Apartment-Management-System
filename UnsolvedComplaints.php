...
<html>
    <head>
        <title>UnsolvedComplaints</title>
    </head>
...
<body style="background-image: url(http://localhost/Surya/Images/Complaints.jpg);background-attachment: fixed;background-size: cover;">
    ...
    <table style="width:100%; margin-bottom:20px;">
        <tr>
            ...
            <th><a href="UnsolvedComplaints.php"><button class="but" id="th" ><h1>Raised Complaints</h1></button></a></th>
    ...
    //   $ApNo=$_SESSION["ApartNo"];
      ...
      if($conn){
        $sql="SELECT * FROM techciti.complaints WHERE Status='Unsolved' ORDER BY Date DESC";
