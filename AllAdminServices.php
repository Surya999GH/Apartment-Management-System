...
<body style="background-image: url(http://localhost/Surya/Images/Complaints.jpg);background-attachment: fixed;background-size: cover;">
    ...
    <table style="width:100%; margin-bottom:20px;">
        <tr>
            <th><a href="AllAdminServices.php"><button class="but" id="th"><h1>All Payments</h1></button></a></th>
    ...
    <?php
      ...
      if($conn){
        $sql="SELECT * FROM techciti.waterbill ORDER BY Date DESC";
        $res=mysqli_query($conn,$sql);
        
    ?>
        
      <div style="height: auto;width:auto; margin: 0 auto;text-align: center;">
        <table  cellspacing="0" style="width:100%;background-color: rgb(165, 165, 51);" border="1">
            <tr><th colspan="7">Water Bills</th></tr>
            <tr>
            <th>Apartment No</th>
            <th>State</th>
            <th>Board</th>
        ...
        <tr>
            ...
            <td><?php echo $row["RRNumber"]; ?></td>
            <td><?php echo $row["Amount"]; ?></td>
            <td><?php echo $row["Date"]; ?></td>
            <th>
            <button type="submit" style="width:200px;height:50px;color:red;background-Color:black;"><h2>Paid</h2></button>
            </th>
        </tr>
        ...
        <?php 
            ...
            echo "<tr><th colspan='6'><h1>No Payments</h1></th></tr>";
        }
        }
        else{
        ...
        <table cellspacing="0" style="width:100%;background-color: rgb(165, 165, 51);" border="1">
        <tr><th colspan="7">Electricity Bills</th></tr>
    <?php
      if($conn){
        $sqlc="SELECT * FROM techciti.currentbill ORDER BY Date DESC";
    ...
    ?>
        ...
        <table cellspacing="0" style="width:100%;background-color: rgb(165, 165, 51);" border="1">
        <tr><th colspan="7">Taxi Bookings</th></tr>
        
    <?php
      if($conn){
        $sqlt="SELECT * FROM techciti.booktaxi ORDER BY BookedDate DESC";
    ...
    ?>
        ...
        <?php 
            ...
            echo "<tr><th colspan='6'><h1>No Bookings</h1></th></tr>";
        }
        }
        else{
        ...
        <table cellspacing="0" style="width:100%;background-color: rgb(165, 165, 51);" border="1">
        <tr><th colspan="8">Restaurant Bookings</th></tr>
        <?php
      if($conn){
        $sqlr="SELECT * FROM techciti.bookrest ORDER BY BookedDate DESC";
