...
<html>
    <head>
        <title>AdminWaterServices</title>
    </head>
...
<body style="background-image: url(http://localhost/Surya/Images/Complaints.jpg);background-attachment: fixed;background-size: cover;">
    ...
    <table style="width:100%; margin-bottom:20px;">
        <tr>
            ...
            <th><a href="AdminWaterServices.php"><button class="but" id="th"><h1>Water Bills</h1></button></a></th>
    ...
    ?>
      ...
      <div style="height: auto;width:auto; margin: 0 auto;text-align: center;float: left;">
