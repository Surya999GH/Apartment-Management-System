...
<html>
    <head>
        <title>RestaurantBookingPayments</title>
...
<body style="background-image: url(Bg.jpg);background-attachment: fixed;background-size: cover;">
  ...
  <div style="float: left;height: auto;width: 100%;background-color: rgb(28, 44, 44);color: brown;">
    ...
    <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; MyPayments-Restaurant Booking Payments</span>
      ...
      <div style="margin: 0 auto;width: 85%;">
        <table>
            <tr>
                ...
                <th><a href="http://localhost/Surya/TBPay.php"><button class="button">TaxiBooking PayMents</button></a></th>
                <th><a href="http://localhost/Surya/RBPay.php"><button class="but">RestaurantBooking PayMents</button></a></th>
            </tr>
        </table>
        <table cellspacing="0" border="1" cellpadding="10px" style="background-color: rgb(165, 165, 51);">
        <caption><h1>Restaurant Booking Payments</h1></caption>
            <tr>
                <th>Name</th>
                <th>No Of Tables</th>
                <th>Mobile Number</th>
            ...
            <?php
                ...
                if($conn){
                $sql="SELECT * FROM techciti.bookrest WHERE ApartmentNo='$ApNo' and Gmail='$Gm'";
