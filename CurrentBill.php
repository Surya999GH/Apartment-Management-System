...
<body style="background-image: url(Bg.jpg);background-attachment: fixed;background-size: cover;">
  ...
  <div style="float: left;height: auto;width: 100%;background-color: rgb(28, 44, 44);color: brown;">
    ...
    <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Electricity Bill</span>
  ...
  <script>
    ...
    <div style="width: 100%;">
      <div style="float: right;width: 15%;height: 100%; text-align: center;background-color: aqua;">
          <h1 style="writing-mode: vertical-rl; padding: 50px;height: 85%;">Electricity Bill</h1>
      </div>
      <div style="float: left;width: 85%;">
        <form method="post" action="CurrentBill.php">
        ...
        ?>    
            <table cellspacing="15px">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><select style="border-radius: 12px;" name="SerPro">
                            <option name="APCPDCL">Central Power Distribution</option>
                            <option name="APEPDCL" selected>Estern Power Dirtribution</option>
                            <option name="APSPDCL">Southern Power Distribution</option>
                        </select>
                        </td>
                    </tr>
                    <tr>
                        <td>Amount</td>
                        <td>:</td>
                        <td><input type="text" name="Amt" required placeholder="Bill Amount"></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td>:</td>
    ...
    <?php
            ...
            else
            {
                ...
                if($_SESSION["ApartNo"]==$ApNo )
                {
                    ...
                    if($conn){
                        // CREATE TABLE `techciti`.`currentbill` ( `ApartmentNo` VARCHAR(10) NOT NULL , `Gmail` VARCHAR(30) NOT NULL , `State` VARCHAR(25) NOT NULL , `ServiceProvider` VARCHAR(40) NOT NULL , `ConsumerNo` VARCHAR(25) NOT NULL , `Amount` INT NOT NULL , `Date` DATE NOT NULL , `Card No` INT NOT NULL , `PayMobileNo` INT NOT NULL , `Status` VARCHAR(10) NOT NULL , PRIMARY KEY (`ApartmentNo`, `Date`)) ENGINE = InnoDB;
                        $sql="INSERT INTO techciti.currentbill(ApartmentNo,Gmail,State,ServiceProvider,ConsumerNo,Amount,Date,CardNo,PayMobileNo,Status) VALUES('$ApNo','$Em','$St','$SerPro','$ConNo',$Amt,'$Dat',$CDNo,$PMobNo,'$Status')";
