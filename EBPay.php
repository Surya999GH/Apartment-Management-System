...
<body style="background-image: url(Bg.jpg);background-attachment: fixed;background-size: cover;">
  ...
  <div style="float: left;height: auto;width: 100%;background-color: rgb(28, 44, 44);color: brown;">
    ...
    <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; MyPayments-Electricity Bill Payments</span>
      ...
      <div style="margin: 0 auto;width: 85%;">
        <table>
            <tr>
                ...
                <th><a href="http://localhost/Surya/EBPay.php"><button class="but">ElectricityBill PayMents</button></a></th>
        ...
        <caption><h1>Electricity Bill Payments</h1></caption>
            <tr>
                <th>State</th>
            ...
            <?php
                ...
                if($conn){
                $sql="SELECT * FROM techciti.currentbill WHERE ApartmentNo='$ApNo' and Gmail='$Gm'";
