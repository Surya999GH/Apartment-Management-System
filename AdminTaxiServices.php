...
<body style="background-image: url(http://localhost/Surya/Images/Complaints.jpg);background-attachment: fixed;background-size: cover;">
    ...
    <table style="width:100%; margin-bottom:20px;">
        <tr>
            ...
            <th><a href="AdminTaxiServices.php"><button class="but" id="th"><h1>Taxi Bills</h1></button></a></th>
    ...
    <?php
      ...
      if($conn){
        $sql="SELECT * FROM techciti.booktaxi ORDER BY BookedDate DESC";
        $res=mysqli_query($conn,$sql);
        
    ?>
        
      <div style="height: auto;width:auto; margin: 0 auto;text-align: center;float: right; margin-right:50px">
