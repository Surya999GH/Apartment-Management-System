...
<html>
    <head>
        <title>Water Bill Payments</title>
...
<body style="background-image: url(Bg.jpg);background-attachment: fixed;background-size: cover;">
  ...
  <div style="float: left;height: auto;width: 100%;background-color: rgb(28, 44, 44);color: brown;">
    ...
    <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; MyPayments-WaterBill Payments</span>
  ...
  <script>
    ...
    <div style="width: 100%;">
      <div style="margin: 0 auto;width: 85%;">
        <table>
            <tr>
                <th><a href="http://localhost/Surya/WBPay.php"><button class="but">WaterBill PayMents</button></a></th>
        ...
        <caption><h1>Water Bill Payments</h1></caption>
            <tr>
                <th>State</th>
                <th>Board</th>
                <th>RR Number</th>
            ...
            <?php
                ...
                if($conn){
                $sql="SELECT * FROM techciti.waterbill WHERE ApartmentNo='$ApNo' and Gmail='$Gm'";
