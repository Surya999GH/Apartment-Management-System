...
<body style="background-image: url(http://localhost/Surya/Images/Complaints.jpg);background-attachment: fixed;background-size: cover;">
    ...
    <table style="width:100%; margin-bottom:20px;">
        <tr>
            <th><a href="AdminComplaints.php"><button class="button" id="th" ><h1>All Complaints</h1></button></a></th>
            <th><a href="UnsolvedComplaints.php"><button class="button" id="th"><h1>Raised Complaints</h1></button></a></th>
            <th><a href="SolvedComplaints.php"><button class="but" id="th"><h1>Solved Complaints</h1></button></a></th>
        </tr>
    </table>
    ...
    <?php
      ...
      if($conn){
        $sql="SELECT * FROM techciti.complaints WHERE Status='Solved' ORDER BY Date DESC";
    ...
    ?>
      ...
      <div style="height: auto;margin: 0 auto;text-align: center;float: left;">
        ...
        <tr>
            ...
            <th>
                ...
                if($row["Status"]=="Solved"){
                    ?>
                <!-- <form method="post" action="SolvedComplaints.php">
                <input value="<?php echo $row["ApartmentNo"]; ?>" hidden>
                <input value="<?php echo $row["Sector"]; ?>" hidden>
                <button type="submit" style="width:200px;height:50px;color:red;background-Color:black;"><h2>Solve</h2></button>
                </form> -->
        ...
        <?php 
            ...
            echo "<tr><th colspan='6'><h1>No Solved Complaints</h1></th></tr>";
        }
        }
        else{
